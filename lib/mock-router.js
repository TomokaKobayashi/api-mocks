...
const createValidator = (validationArgs) => {
    const validator = new openapi_request_validator_1.default(validationArgs);
    return (req, res, next) => {
...
const debugMiddle = (req, res, next) => {
    console.log(req.url);
    next();
};
            ...
            switch (endpoint.method) {
                case "GET":
                    ...
                    if (endpoint.validatorArgs) {
                        mockRouter.get(endpoint.pattern, createValidator(endpoint.validatorArgs));
                    }
                ...
                case "POST":
                    ...
                    if (endpoint.validatorArgs) {
                        mockRouter.post(endpoint.pattern, createValidator(endpoint.validatorArgs));
                    }
                ...
                case "PUT":
                    ...
                    if (endpoint.validatorArgs) {
                        mockRouter.put(endpoint.pattern, createValidator(endpoint.validatorArgs));
                    }
                ...
                case "PATCH":
                    ...
                    if (endpoint.validatorArgs) {
                        mockRouter.patch(endpoint.pattern, createValidator(endpoint.validatorArgs));
                    }
                ...
                case "DELETE":
                    ...
                    if (endpoint.validatorArgs) {
                        mockRouter.delete(endpoint.pattern, createValidator(endpoint.validatorArgs));
                    }
