    ...
    try {
        ...
        if (metadata.data) {
            if (!metadata.datatype || metadata.datatype === 'file') {
                ...
                const dataPath = path_1.default.isAbsolute(dataFileName) ? dataFileName : basePath + '/' + dataFileName;
...
const loadMetadata = (baseDir, filePath) => {
    const metadataPath = path_1.default.isAbsolute(filePath) ? filePath : baseDir + '/' + filePath;
